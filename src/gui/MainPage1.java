...
public class MainPage1 extends JFrame {
    ...
    public MainPage1() {
        ...
        contentPanel.add(createPembayaranPage(), "Pembayaran");
        contentPanel.add(createHistoryPage(), "History");

        B.add(contentPanel, BorderLayout.CENTER);
        ...
        btnPelayananHewan.addActionListener(e -> cardLayout.show(contentPanel, "Pelayanan Hewan"));
    ...
    private JPanel createPembayaranPage() {
        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        JLabel label = new JLabel("Pembayaran Page");
        label.setFont(new Font("Arial", Font.BOLD, 24));
        panel.add(label);
        return panel;
    }
    ...
    private JPanel createHistoryPage() {
        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        JLabel label = new JLabel("History Page");
        label.setFont(new Font("Arial", Font.BOLD, 24));
        panel.add(label);
        return panel;
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MainPage1::new);
    }
}